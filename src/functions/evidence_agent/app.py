...
def _evaluate_evidence_with_gemini(
    ...
    prompt = (
        ...
        "Each document has a title (and optional documentKind) stating what the "
        "member said the file is. Prefer the matching labeled document for each "
        "check — e.g. use the KYC document for kyc_present — but still require a "
        "verbatim excerpt from that document's text.\n\n"
